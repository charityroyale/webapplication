...
const DonatePage: NextPage<InitialDonationProps> = ({ project }: InitialDonationProps) => {
	...
	return (
		<React.Fragment>
			<Head>
				<title>Charity Royale 2020 - Community</title>
				...
				<meta property="og:title" content={`Community Spendenseite`} key="ogtitlestreamer" />
			...
			<DonationHeader noMargin={true} title={project.tagline} description={project.descripion}>
				<React.Fragment>
